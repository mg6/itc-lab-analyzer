...
{
    public class PathCombineCodeFixProvider
    {
        public const string Title = "Change to Path.Combine";

        public async Task<Document> MakePathCombineAsync(Document document, LiteralExpressionSyntax litExp, CancellationToken cancellationToken)
        {
